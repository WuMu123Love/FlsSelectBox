...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1361825681@qq.com/FlsSelectBox'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1361825681@qq.com' => 'wumuanhuihf@163.com' }
  s.source           = { :git => 'https://github.com/1361825681@qq.com/FlsSelectBox.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FlsSelectBox' => ['FlsSelectBox/Assets/*.png']
  # }
